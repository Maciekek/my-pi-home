...
const createDashboardByLocationId = (locationId, payload) => {
  return (dispatch) => {
    DashboardsService.createDashboardByLocationId(locationId, payload)
      .then((response) => {
...
const updateDashboardByLocationId = (locationId, payload) => {
  return (dispatch) => {
    DashboardsService.updateDashboardByLocationId(locationId, payload)
      .then((response) => {
        dispatch(dashboardByIdLoaded(response.data));
      })
      .catch(() => {});
...
const removeWidgetByIndex = (locationId, widgetIndex) => {
  return (dispatch) => {
    DashboardsService.removeWidgetById(locationId, widgetIndex)
      .then((response) => {
        dispatch(dashboardByIdLoaded(response.data));
      })
      .catch(() => {});
