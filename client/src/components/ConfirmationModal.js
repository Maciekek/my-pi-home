...
const ConfirmationModal = () => {
  ...
  return (
    <Modal onHide={onCancel} size="lg" show={isModalActive} aria-labelledby="contained-modal-title-vcenter" centered>
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter"></Modal.Title>
      </Modal.Header>
      <Modal.Body>{modalParams.message ? modalParams.message : 'Czy na pewnie chcesz wykonać operacje?'}</Modal.Body>
      <Modal.Footer>
